...
public class CheckBox {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement triStateCheckbox = driver.findElement(
				By.xpath("(//div[contains(@class,'ui-chkbox-box ui-widget ui-corner-all ui-state-default')])[8]"));
		...
		// Select the dropdown "Select Multiple Options" which is having checkbox type
		// values
		...
		// Click "Miami"
		WebElement dropDownBerlin = driver.findElement(By.xpath("(//label[text()='Miami'])[2]"));
		dropDownBerlin.click();

		// Click "Rome"
		WebElement dropDownLondon = driver.findElement(By.xpath("(//label[text()='Rome'])[2]"));
